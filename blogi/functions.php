...
function _tk_setup() {
	...
	*/
	...
	add_image_size( 'single-thumb', 750, 450, true );
...
function _tk_widgets_init() {
	...
	register_sidebar(array ( 
			'name'			=> __( 'Footer Box 1', '_tk'  ),
			'id' 			=> 'footer-widget1',
			'description' 	=> __( 'This is first box of footer from left side.', 'nm-blogo' ),
	...
	register_sidebar(array ( 
			'name'			=> __( 'Footer Box 2', '_tk'  ),
			'id' 			=> 'footer-widget2',
			'description' 	=> __( 'This is secont box of footer from left side.', 'nm-blogo' ),
			'before_widget' => '<div class="foot-widget">',
    		'after_widget'  => '</div>',
			'before_title' 	=> '<h3>',
			'after_title' 	=> '</h3>',
	...
	register_sidebar(array ( 
			'name'			=> __( 'Footer Box 3', '_tk' ),
			'id' 			=> 'footer-widget3',
			'description' 	=> __( 'This is third box of footer from left side.', 'nm-blogo' ),
			'before_widget' => '<div class="foot-widget">',
    		'after_widget'  => '</div>',
			'before_title' 	=> '<h3>',
			'after_title' 	=> '</h3>',
