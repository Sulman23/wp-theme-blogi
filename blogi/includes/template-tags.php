...
function _tk_posted_on() {
	...
	if ( get_the_time( 'U' ) !== get_the_modified_time( 'U' ) ){
		...
		$time_string .= __(', <i class="fa fa-refresh"></i> ', '_tk') . $time_string_update;
	}

	printf( __( '<span class="posted-on"><i class="fa fa-clock-o"></i>%1$s</span> <span class="byline"><i class="fa fa-user"></i>%2$s</span>', '_tk' ),
		$time_string,
