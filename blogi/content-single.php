	...
	<div class="entry-content">
		...
		<?php 
		    if (has_post_thumbnail()) {
		        echo '<div class="entry-content-thumbnail">';
	...
	<footer class="entry-meta">
		<?php
			...
			if ( ! _tk_categorized_blog() ) {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( '<i  class="fa fa-folder"></i> %1$s <i  class="fa fa-tags"></i> %2$s.<i  class="fa fa-bookmark-o"></i> Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', '_tk' );
				} else {
					$meta_text = __( '<i  class="fa fa-folder"></i> %1$s. <i  class="fa fa-bookmark-o"></i> Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', '_tk' );
				}
